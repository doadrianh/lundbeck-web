...
import useInterruptedActions from "../agent-inbox/hooks/use-interrupted-actions";
    ...
    <div className="border border-gray-200 rounded-lg overflow-hidden">
      ...
      >
        ...
        <div className="flex flex-row gap-2 items-center justify-end w-full p-2">
          <Button
            variant="outline"
            className="text-  -800 border-gray-500 font-normal bg-green-500 hover:bg-green-600"
            onClick={handleMemoizeInterrupt}
          >
            Yes, Memoize
          </Button>
          <Button
            variant="outline"
            className="text-gray-800 border-gray-500 font-normal bg-red-500 hover:bg-red-600"
            onClick={handleIgnoreInterrupt}
          >
            No, Ignore
          </Button>
        </div>
